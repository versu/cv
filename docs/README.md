...
印刷発注者からの印刷物制作の受注、印刷工場への発注手配、製造結果のステータス返却までを一元管理し、印刷物制作のオペレーション全体を包括的に支援します。
本システムは、入稿された原稿データを印刷仕様に最適化し、自動で印刷データを生成。
発注ルールに基づき、印刷工場の選定から発注、納品状況の管理までを効率化します。

これにより、印刷発注者は煩雑な印刷発注業務の効率化、進行状況の可視化、発注ミスの防止が可能であり、印刷工場は新規受注機会の獲得、製造指示の標準化による業務効率化が可能となります。
...
https://www.goof.buzz/solution/software/oneflow
...
セグメント情報をMAから受領し、顧客に応じた
訴求コンテンツ(パーソナライズされた同梱チラシ)を
提供する仕組みを構築。

【担当業務】

・基幹システムと自社組版サービス間の連携を支援する
　システムの設計・開発
・自社パッケージの導入支援

【チームの課題と自身が工夫したこと】

・開発用SFTPサーバのモックとして、Dockerを初めて使用
